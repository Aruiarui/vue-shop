      ...
      <div class="login_content">
        <form>
          <div :class="{on: isShowSms}" >
            <section class="login_message">
              ...
              <button :disabled="!isRightPhone || computeTime>0" class="get_verification"
                      ...
                      @click.prevent="sendCode">{{computeTime>0 ? `已发送(${computeTime}s)` : '获取验证码'}}
              </button>
          ...
          <div :class="{on: !isShowSms}">
            <section>
              <section class="login_message">
                <input type="text" maxlength="11" placeholder="手机"
              ...
              <section class="login_message">
                <input type="text" maxlength="11" placeholder="验证码"
                       v-model="captcha" name="captcha" v-validate="{required:true, regex:/^.{4}$/}">
...
<script>
  import {reqCode, reqPwdLogin, reqSmsLogin} from "../../api/index";
  ...
  export default {
    data() {
      return {
        ...
        isShowSms: false ,//选择登陆方式，true为短信登陆，false为密码登陆
